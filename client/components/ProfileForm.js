...
export default function ProfileForm(props) {
    ...
    const validationSchema = yup.object().shape({
        ...
        addres: yup.string().when('userType', {
            is: true,
    ...
    return(
        ...
        initialValues={{
            ...
            addres:  props.user?.profile?.addres|| '',
        ...
        >
            {
                ({handleChange, handleBlur, handleSubmit, errors, values, setFieldValue, isValid}) => (
                    <>
                            ...
                            <>
                               <Input
                                ...
                                <Input
                                    ...
                                    value={values.addres}
                                    placeholder="العنوان"
                                    style={[styles.textInput, errors.addres && styles.errorInput]}
                                />
                                {errors.addres &&
                                    <Text p style={styles.textError}>{errors.addres}</Text>
                                }
                                <Input
                                    name="phone"
                      ...
                      <Button title={props.buttonTitle} style={{ marginTop: '20px'}} onPress={handleSubmit}  />
                    </>
                )
            }
        </Formik>
